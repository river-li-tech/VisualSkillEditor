...
static const QString SKILLINST_WORK_DIR_DEFAULT = "/Project/";//search path for SkillInst.txt
...
static const QString SKILLGFX_WORK_DIR_DEFAULT = "/Project/"; //search path for SkillGfx.txt
...
static const QString SKILLSCRIPT_WORK_DIR_DEFAULT = "/Project/";//search path for skill script file(1st)
